...
window.addEventListener('focus', function (e) {
   ...
   if (snailBait.paused) {
      ...
      if (snailBait.windowHasFocus && snailBait.countdownInProgress)
         snailBait.revealToast('5', 1000); // Display 3 for 1.0 seconds

      setTimeout(function (e) {
         if (snailBait.windowHasFocus && snailBait.countdownInProgress)
            snailBait.revealToast('4', 1000); // Display 2 for 1.0 seconds

         setTimeout(function (e) {
            if (snailBait.windowHasFocus && snailBait.countdownInProgress)
               snailBait.revealToast('3', 1000); // Display 2 for 1.0 seconds
